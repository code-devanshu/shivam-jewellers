...
export async function GET(
  ...
  const invoiceData: BillInvoiceData = {
    ...
    items: bill.items.map((item) => ({
      ...
      grossWeightGrams: item.grossWeightGrams ? Number(item.grossWeightGrams) : null,
    ...
    discountAmount: bill.discountAmount ? Number(bill.discountAmount) : null,
    exchangeValue: bill.exchangeValue ? Number(bill.exchangeValue) : null,
    exchangeLabel: bill.exchangeLabel,
